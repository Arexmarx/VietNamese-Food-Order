...
public class historyOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Order> list = d.getAllOrders(acc.getAccid(),Integer.parseInt(status));
            request.setAttribute("HistoryOrder", list);
            request.getRequestDispatcher("MainController?action=historyOrder").forward(request, response);
        }
    }
